...
local State = {
    ...
    targetImages = {},
    AnimationCachePath = "PeppermintGrave/AnimationCache.json",
    AnimationCache = {},
    AnimationListCachePath = "PeppermintGrave/AnimationListCache.json",
    EmoteListCachePath = "PeppermintGrave/EmoteListCache.json",
    CustomAnimationPath = "PeppermintGrave/CustomAnimations.json",
    CustomAnimations = {},
    ...
    EmotePagePath = "PeppermintGrave/EmotePages.json",
    EmotePages = {},
    currentEmotePageName = "Default",
    EmoteDataCachePath = "PeppermintGrave/EmoteDataCache.json"
}
...
function saveAnimationCache()
    if writefile then
        pcall(function()
            if not isfolder("PeppermintGrave") then makefolder("PeppermintGrave") end
...
function GetAsset(asset, preloadedBytes)
    ...
    if assetStr:find("http") then
        ...
        local path = "PeppermintGrave/Assets/" .. filename
        ...
        if not isfolder("PeppermintGrave/Assets") then 
            pcall(function()
                if not isfolder("PeppermintGrave") then makefolder("PeppermintGrave") end
                makefolder("PeppermintGrave/Assets") 
            end)
        end
...
local ConfigPath = "PeppermintGrave/EmoteSettings.json"
...
local ThemeConfigPath = "PeppermintGrave/EmoteThemes.json"
...
function disconnectAllConnections()
    ...
    if ContextActionService then
        ContextActionService:UnbindAction("PeppermintGrave_EmoteWheelHotkeys")
    end
end
...
function connectEvents()
    ...
    local function bindWheelHotkeys()
        ...
        ContextActionService:BindActionAtPriority(
            "PeppermintGrave_EmoteWheelHotkeys",
            onHotkey,
            false,
...
enterHUDEditor = function()
    ...
    local selectionGui = game:GetService("CoreGui"):FindFirstChild("PeppermintGrave_HUDSelection")
    if not selectionGui then
        selectionGui = Instance.new("ScreenGui")
        selectionGui.Name = "PeppermintGrave_HUDSelection"
